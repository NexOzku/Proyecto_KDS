// admin.js - Panel de administración (limpio, con persistencia de vista via location.hash)

// ---------- Utilidades: Toasts y confirm modal ----------
...
function initSidebarDelegation(){
  ...
  sidebar.addEventListener('click',(e)=>{
    ...
    e.stopPropagation();
    // botones especiales
    if(li.id==='logoutBtn'){ showConfirm('¿Deseas cerrar sesión?', ()=>{ localStorage.clear(); sessionStorage.clear(); window.location.href='index.html?logout=true'; }); return; }
